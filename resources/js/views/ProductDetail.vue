<template>
    <!-- breadcrumb-area -->
    <div class="breadcrumb-area breadcrumb-style-two" data-background="/front_assets/img/bg/s_breadcrumb_bg01.jpg">
        <div class="container">
            <div class="row">
                            ...
                            <div class="cart-plus-minus">
                                <form action="#" class="num-block">
                                    ...
                                    <div class="qtybutton-box">
                                        <span class="plus"><img src="/front_assets/img/icon/plus.png" alt=""></span>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="description" role="tabpanel"
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    ...
                                    est laborum.</p>
                                <p>The purpose of lorem ipsum is to create a natural looking block of text (sentence,
                                    paragraph, page, etc.) that doesn't
            ...
            <div class="related-product-wrap">
                ...
                <div class="row related-product-active">
                    <div class="col-xl-3">
                        <div class="new-arrival-item text-center">
                            <div class="thumb mb-25">
                                <a href="shop-details.html"><img src="/front_assets/img/product/n_arrival_product01.jpg"
                                        alt=""></a>
                    ...
                    <div class="col-xl-3">
                        <div class="new-arrival-item text-center">
                            <div class="thumb mb-25">
                                ...
                                <a href="shop-details.html"><img src="/front_assets/img/product/n_arrival_product02.jpg"
                                        alt=""></a>
                                <div class="product-overlay-action">
                                    <ul>
                                        <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="col-xl-3">
                        <div class="new-arrival-item text-center">
                            <div class="thumb mb-25">
                                <a href="shop-details.html"><img src="/front_assets/img/product/n_arrival_product03.jpg"
                                        alt=""></a>
                                <div class="product-overlay-action">
                                    <ul>
                                        <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="col-xl-3">
                        <div class="new-arrival-item text-center">
                            <div class="thumb mb-25">
                                ...
                                <a href="shop-details.html"><img src="/front_assets/img/product/n_arrival_product04.jpg"
                                        alt=""></a>
                                <div class="product-overlay-action">
                                    <ul>
                                        <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
...
export default {
    ...
    methods: {
        async getProductData() {
            let response = await axios.get(getUrlList().getProductData + '/' + this.$route.params.slug,);

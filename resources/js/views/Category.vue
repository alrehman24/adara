                                ...
                                <div class="thumb mb-25">
                                    ...
                                    <div class="product-overlay-action">
                                        <ul>
                                            ...
                                            <li>
                                                <!-- <router-link :to="'/product/' + item.slug"><i class="far fa-eye"></i></router-link> -->
                                                <router-link :to="'/product/' + item.slug"><i class="far fa-eye"></i></router-link>
                                                <!-- <a href="shop-details.html"><i class="far fa-eye"></i></a> -->
                                                <!-- <router-link :to="'/product/' + item.slug">{{ item.name }}</router-link> -->
                                                <!-- <router-line :to="'/product/' + item.slug"><i
                                                        class="far fa-eye"></i></router-line> -->
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <aside class="shop-sidebar">
                        ...
                        <div class="widget">
                            ...
                            <div class="shop-cat-list">
                                <ul>
                                    <li v-for="item in subcategories" :key="item.id"><a href="#">{{ item.name
                                    }}</a><span>({{ item.products_count }})</span></li>
                        ...
                        <div class="widget">
                            ...
                            <div class="sidebar-brand-list">
                                <ul>
                                    <li v-for="item in brands" :key="item.id"><a href="#">{{ item.text }} <i
